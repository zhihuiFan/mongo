(function() {
  ...
  let QuickDB = db.getSiblingDB('quickdb20171229')
  assert.commandWorked(QuickDB.dropDatabase());
  QuickDB.setProfilingLevel(1, 10000)
  assert(QuickDB.system.profile.count() < 2, "db.system.profile is not empty as the beginging")
